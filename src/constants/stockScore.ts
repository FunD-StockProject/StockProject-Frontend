...
const ARRAY_STOCK_SCORE_TITLE = [
  stockScoreTitle.bad,
  stockScoreTitle.poor,
  stockScoreTitle.normal,
  stockScoreTitle.good,
  stockScoreTitle.excellent,
];
const ARRAY_STOCK_SCORE_IMAGE = [
  stockScoreImage.bad,
  stockScoreImage.poor,
  stockScoreImage.normal,
  stockScoreImage.good,
  stockScoreImage.excellent,
];
